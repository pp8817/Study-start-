...
class Fighter(pygame.sprite.Spite):
    def __init__(self):
...
class Missile(pygame.Sprite):
    def __init__(self, xpos, ypos, speed):
        super(Missile, self).__init__()
        self.image = pygame.image.load('missile.png')
        self.rect = self.get_erct()
        self.rect.x = xpos
        self.rect.y = ypos
        self.speed = speed
...
class Rock(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed):
        ...
        rock_images = ('rock01.png','rock02.png','rock03.png','rock04.png','rock05.png','rock06.png','rock07.png','rock08.png','rock09.png','rock10.png', 'rock11.png','rock12.png','rock13.png','rock14.png','rock15.png','rock16.png','rock17.png','rock18.png','rock19.png','rock20.png','rock21.png','rock2.png','rock23.png','rock24.png','rock25.png','rock26.png','rock27.png','rock28.png','rock29.png','rock30.png',)
    ...
    def out_of_scree(self):
        if self.rect.y > WINDOW_HEIGHT:
            return True

def draw_text(text, font, surface, x, y, main_color):
    text_obj = font.render(text, True, main_color)
    text_rect = text.obj.get_rect()
    text_rect.centerx = x
    text_rect.centery = y
...
def game_loop():
    ...
    while not done:
        ...
        screen.bilt(background_image, background_image.get_rect())
        ...
        if random.randint(1, occur_prob) == 1:
            for i in range(occur_of_rocks):
                ...
                rock = Rock(random.rendint(0, WINDOW_WIDTH - 30),0,speed)
                rocks.add(rock)
